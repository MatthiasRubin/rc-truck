...
module housingTop()
{
  difference()
  {
    union()
    {
      ...
      mirrorCopy([1,0,0]) translate([20,0,0]) cube([10,18,25], center = true);
    ...
    mirrorCopy([1,0,0]) translate([20,0,0]) cylinder(d = 4.1, h = 15);
    
    // add holes for nuts
    mirrorCopy([1,0,0]) translate([20,0,0]) cylinder(d = 8, h = 8, $fn = 6);
